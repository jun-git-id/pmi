		...
		<div class="swiper-container swiper-parent">
			<div class="swiper-wrapper">
				<div class="swiper-slide">
					...
					<div class="swiper-slide-bg" style="background-image: url('assets/depan/demos/medical/images/slider/1.jpg');"></div>
				</div>
				<div class="swiper-slide">
					<div class="container">
					...
					<div class="swiper-slide-bg" style="background-image: url('assets/depan/demos/medical/images/slider/2.jpg');"></div>
				</div>
			</div>
...
<section id="content">
	<div class="content-wrap">
		...
		<div class="section row p-0 align-items-stretch dark topmargin-sm">
			<div class="col-lg-5" style="background: url('assets/depan/demos/medical/images/section-bg.jpg') center center no-repeat; background-size: cover; min-height: 250px;">
				<div>&nbsp;</div>
			</div>
				...
				<div class="col-md-5">
					...
					<ul class="testimonials-grid grid-1">
						<li class="grid-item pt-0">
							<div class="testimonial">
								<div class="testi-image">
									<a href="#"><img src="<?= base_url(); ?>assets/depan/images/testimonials/1.jpg" alt="Customer Testimonails"></a>
								</div>
						...
						<li class="grid-item pb-0">
							<div class="testimonial">
								<div class="testi-image">
									<a href="#"><img src="<?= base_url(); ?>assets/depan/images/testimonials/2.jpg" alt="Customer Testimonails"></a>
								</div>
								<div class="testi-content">
			...
			<div id="oc-team" class="owl-carousel team-carousel carousel-widget" data-margin="30" data-nav="true" data-pagi="true" data-items-xs="1" data-items-sm="2" data-items-lg="3" data-items-xl="4">
				...
				<div class="team">
					<div class="team-image">
						<img src="<?= base_url(); ?>assets/depan/demos/medical/images/doctors/1.jpg" alt="Dr. John Doe">
					</div>
					<div class="team-desc">
				...
				<div class="team">
					<div class="team-image">
						<img src="<?= base_url(); ?>assets/depan/demos/medical/images/doctors/2.jpg" alt="Dr. John Doe">
					</div>
					<div class="team-desc">
						<div class="team-title">
				...
				<div class="team">
					<div class="team-image">
						<img src="<?= base_url(); ?>assets/depan/demos/medical/images/doctors/3.jpg" alt="Dr. John Doe">
					</div>
					<div class="team-desc">
						<div class="team-title">
				...
				<div class="team">
					<div class="team-image">
						<img src="<?= base_url(); ?>assets/depan/demos/medical/images/doctors/4.jpg" alt="Dr. John Doe">
					</div>
					<div class="team-desc">
						<div class="team-title">
				...
				<div class="team">
					<div class="team-image">
						<img src="<?= base_url(); ?>assets/depan/demos/medical/images/doctors/6.jpg" alt="Dr. John Doe">
					</div>
					<div class="team-desc">
						<div class="team-title">
				...
				<div class="team">
					<div class="team-image">
						<img src="<?= base_url(); ?>assets/depan/demos/medical/images/doctors/7.jpg" alt="Dr. John Doe">
					</div>
					<div class="team-desc">
						<div class="team-title">
				...
				<div class="team">
					<div class="team-image">
						<img src="<?= base_url(); ?>assets/depan/demos/medical/images/doctors/8.jpg" alt="Dr. John Doe">
					</div>
					<div class="team-desc">
						<div class="team-title">
				...
				<div class="team">
					<div class="team-image">
						<img src="<?= base_url(); ?>assets/depan/demos/medical/images/doctors/9.jpg" alt="Dr. John Doe">
					</div>
					<div class="team-desc">
						<div class="team-title">
