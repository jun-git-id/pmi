...
<script type="text/javascript">
    ...
    function makePDF() {
        ...
        $.ajax({
            url: "<?= site_url('laporankeluar/getPrint') ?>",
            type: "post",
            data: {
                year: $("#pilYear").val()
            },
        ...
        doc.setFontSize(12);
        doc.text(`Laporan Darah Keluar - ${newDate}`, 20, 20);
        ...
        html2canvas(document.querySelector("#capture"), {
            ...
            doc.save(`LAPORAN DARAH KELUAR - ${newDate}.pdf`);
        });
    }
            ...
            <div class="modal-content">
                ...
                <form action="<?= site_url('laporankeluar/edit') ?>" method="post">
                    ...
                    <div class="d-flex flex-column mb-8 fv-row">
                            ...
                            <!--end::Label-->
                            <input type="text" class="form-control form-control-solid" id="nikEditKeluar" name="nik_pendonor" />
                        </div>
                        <div class="d-flex flex-column mb-8 fv-row">
                            <!--begin::Label-->
                            <label class="d-flex align-items-center fs-6 fw-bold mb-2">
...
<script type="text/javascript">
    ...
    $.ajax({
        url: "<?= site_url('laporankeluar/keluarChart') ?>",
        type: "post",
    ...
    $('#dataTableLaporanKeluar tbody').on('click', '.dtl_laporankeluar', function() {
        ...
        $.ajax({
            ...
            success: res => {
                ...
                $('#nikDetailKeluar').html(res[0].nik_pendonor)
    ...
    $('#dataTableLaporanKeluar tbody').on('click', '.edit_laporankeluar', function() {
        ...
        $.ajax({
            ...
            success: res => {
                $('#nikEditKeluar').val(res[0].nik_pendonor)
