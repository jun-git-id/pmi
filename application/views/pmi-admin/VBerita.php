                            ...
                            <div class="card mb-5 mb-xl-8">
                                ...
                                <div class="card-header border-0 pt-5">
                                    <h3 class="card-title align-items-start flex-column">
                                        <span class="card-label fw-bolder fs-3 mb-1">Berita / Publikasi PMI</span>
                                    </h3>
                                    <div class="card-toolbar">
                                        <a href="#" class="btn btn-primary " data-bs-toggle="modal" data-bs-target="#mdl_addBerita">Tambah Berita</a>
                                    </div>
                                </div>
                                <!--end::Header-->
                                <!--begin::Body-->
                                <div class="card-body py-3">
                                    ...
                                    <div class="table-responsive">
                                        <!--begin::Table-->
                                        <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3" id="tableBerita">
                                            <!--begin::Table head-->
                                            <thead>
