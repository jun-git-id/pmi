<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed aside-enabled aside-fixed">
    ...
    <div class="d-flex flex-column flex-root">
                            ...
                            <div class="card mb-5 mb-xl-8">
                                ...
                                <div class="card-header border-0 pt-5">
                                    <h3 class="card-title align-items-start flex-column">
                                        <span class="card-label fw-bolder fs-3 mb-1">Jadwal Donor Darah PMI Aceh Selatan</span>
                                    </h3>
                                    <div class="card-toolbar">
                                        <a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add_jadwalUDD">Tambah Jadwal</a>
                                    </div>
                                </div>
                                <!--end::Header-->
                                <!--begin::Body-->
                                <div class="card-body py-3">
                                    ...
                                    <div class="table-responsive">
                                        <!--begin::Table-->
                                        <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3" id="dataTableJadwalUDD">
                                            <!--begin::Table head-->
                                            <thead>
                                            ...
                                            foreach ($udd as $item) {
                                                ...
                                                echo '
                                                    <tr>
                                                        ...
                                                        <td class="text-end">
                                                            <a href="" title="Edit Jadwal" data-bs-toggle="modal" data-bs-target="#editJadwal" data-id="' . $item->id_mobil . '" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm editJadwal me-1">
                                                            ...
                                                            <a href="" title="Hapus Jadwal" data-bs-toggle="modal" data-bs-target="#hapusJadwal" data-id="' . $item->id_mobil . '" data-name="' . $item->lokasi . '" data-jadwal="' . $item->jadwal . '" class="btn btn-icon btn-bg-light btn-active-color-primary hapusJadwal btn-sm">
        ...
        <!-- Jadwal mobil donor keliling  -->
        <!--begin::Wrapper-->
        <div class="wrapper d-flex flex-column flex-row-fluid mt-lg-n21" id="kt_wrapper">
                ...
                <div class="post d-flex flex-column-fluid" id="kt_post">
                    ...
                    <div id="kt_content_container" class="container-xxl">
                        ...
                        <div class="card mb-5 mb-xl-8">
                            ...
                            <div class="card-header border-0 pt-5">
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label fw-bolder fs-3 mb-1">Jadwal Keliling Mobil Donor PMI Aceh Selatan</span>
                                </h3>
                                <div class="card-toolbar">
                                    <a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#mdl_addjadwal">Tambah Jadwal</a>
                                </div>
                            </div>
                            <!--end::Header-->
                            <!--begin::Body-->
                            <div class="card-body py-3">
                                ...
                                <div class="table-responsive">
                                    <!--begin::Table-->
                                    <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3" id="dataTableMobil">
                                        <!--begin::Table head-->
                                        <thead>
                                            <tr class="fw-bolder text-muted">
                                                <th class="min-w-120px">Lokasi</th>
    ...
    <!-- begin modal Tambah Jadwal UDD PMI -->
    <div class="modal fade" id="add_jadwalUDD">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="mb-3">Tambah Jadwal Donor PMI Aceh Selatan</h3>
                ...
                <form action="<?= site_url('mobildonor/store') ?>" method="post">
                    <div class="modal-body">
                        <div class="d-flex flex-column mb-8 fv-row">
                            ...
                            <!--end::Label-->
                            <input type="text" class="form-control form-control-solid" value="PMI Aceh Selatan" name="lokasi" required />
                        </div>
                        <div class="d-flex flex-column mb-8 fv-row">
                            <!--begin::Label-->
                            <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                            ...
                            <div class="position-relative d-flex align-items-center">
                                <!--begin::Datepicker-->
                                <input id="add_dateUDD" class="form-control form-control-solid " placeholder="Pilih Jadwal" name="jadwal" required />
                                <!--end::Datepicker-->
                            </div>
                        </div>
                        <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <div class="row g-9 mb-8">
                            ...
                            <div class="col-md-6 fv-row">
                                ...
                                <input id="add_jambukaUDD" type="text" class="form-control form-control-solid" placeholder="Masukan Jam Buka" name="jam_buka" required />
                            </div>
                            <!--end::Col-->
                            <!--begin::Col-->
                            <div class="col-md-6 fv-row">
                                ...
                                <!--begin::Input-->
                                <input id="add_jamtutupUDD" type="text" class="form-control form-control-solid" placeholder="Masukan Jam Tutup" name="jam_tutup" required />
                                <!--end::Input-->
                            </div>
                            <!--end::Col-->
                        </div>
    ...
    <!-- end modal tambah jadwal UDD PMI-->
    <!-- begin edit Jadwal UDD PMI-->
    <div class="modal fade" id="edit_jadwalUDD">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <form action="<?= site_url('') ?>" method="post">
                    <div class="modal-body">
                        ...
                        <div class="d-flex flex-column mb-8 fv-row">
                            ...
                            <div class="position-relative d-flex align-items-center">
                                <!--begin::Datepicker-->
                                <input id="edit_dateUDD" class="form-control form-control-solid " name="" />
                                <!--end::Datepicker-->
                            </div>
                        </div>
                        <div class="d-flex flex-column mb-8 fv-row">
                            ...
                            <!--end::Label-->
                            <input type="text" class="form-control form-control-solid" id="" name="target" />
                        </div>
                        <!--begin::Input group-->
                        <div class="row g-9 mb-8">
                            <!--begin::Col-->
                            <div class="col-md-6 fv-row">
                                <label class="required fs-6 fw-bold mb-2">Jam Buka</label>
                                <input id="edit_jambukaUDD" type="text" class="form-control form-control-solid" name="" />
                            </div>
                            <!--end::Col-->
                            <!--begin::Col-->
                            <div class="col-md-6 fv-row">
                                <label class="required fs-6 fw-bold mb-2">Jam Tutup</label>
                                <!--begin::Input-->
                                <input id="edit_jamtutupUDD" type="text" class="form-control form-control-solid" name="" />
                                <!--end::Input-->
                            </div>
                            <!--end::Col-->
                        </div>
    ...
    <!-- end modal edit jadwal UDD PMI -->

    <!-- begin hapus Jadwal UDD PMI-->
    <div class="modal fade" id="del_jadwalUDD">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="mb-3">Hapus Jadwal Donor PMI Aceh Selatan</h3>
                ...
                <form action="<?= site_url('') ?>" method="post">
                    <div class="modal-body">
                        <p>Apakah anda yakin ingin menghapus jadwal mobil donor di <b><span id=""></span></b> pada tanggal <b><span id=""></span></b> ?</p>
                    </div>
    ...
    <!-- end modal hapus jadwal UDD PMI -->
